...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/aqua-stade'
    {path: '', pathMatch : 'full', redirectTo: 'aqua-stade'},
...
{
    path: '',
    // canActivate: [NoAuthGuard], // COMMENTEZ temporairement
    // canActivateChild: [NoAuthGuard], // COMMENTEZ temporairement
    ...
    // Landing routes
    {
        ...
        children   : [
            {path: 'aqua-stade', loadChildren: () => import('app/modules/landing/aqua-stade/aqua-stade.module').then(m => m.AquaStadeModule)},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'pages', children: [
                ...
                // User Management
                {path: 'user-management', loadChildren: () => import('app/modules/admin/pages/user-management/user-management.module').then(m => m.UserManagementModule)},
            ]},
